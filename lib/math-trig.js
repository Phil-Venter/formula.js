...
exports.MUNIT = function (dimension) {
  ...
  if (utils.gettype(dimension) === 'error') {
    return dimension;
  }
...
exports.SUBTOTAL = function (function_code, ref1) {
  ...
  if (utils.gettype(function_code) === 'error') {
...
exports.SUM = function () {
  ...
  for (var i = 0; i < argsKeys.length; ++i) {
    ...
    if (utils.gettype(elt) === 'number') {
      result += elt;
    } else if (utils.gettype(elt) === 'string') {
...
exports.SUMPRODUCT = function () {
  ...
  for (var i = 0; i < arguments[0].length; i++) {
    if (utils.gettype(arguments[0][i]) !== 'array') {
      product = 1;
      for (k = 1; k < arrays; k++) {
        _i = utils.parseNumber(arguments[k - 1][i]);
        if (utils.gettype(_i) === 'error') {
          return _i;
        }
        product *= _i;
      }
...
exports.SUMSQ = function () {
  ...
  if (utils.gettype(numbers) === 'error') {
    return numbers;
  }
  var result = 0;
