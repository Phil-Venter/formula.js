...
function ensureDate(d) {
  return (utils.gettype(d) === 'date') ? d : new Date(d);
}
...
exports.CUMIPMT = function (rate, periods, value, start, end, type) {
  ...
  // Credits: Hannes Stiebitzhofer for the translations of function and constiable names
  ...
  const payment = exports.PMT(rate, periods, value, 0, type);
  let interest = 0;
...
exports.IPMT = function (rate, period, periods, present, future, type) {
  ...
  // Compute payment
  const payment = exports.PMT(rate, periods, present, future, type);
...
exports.MIRR = function (values, finance_rate, reinvest_rate) {
  ...
  const num = -exports.NPV(reinvest_rate, incomes) * Math.pow(1 + reinvest_rate, n - 1);
  const den = exports.NPV(finance_rate, payments) * (1 + finance_rate);
