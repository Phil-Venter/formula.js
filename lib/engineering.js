...
exports.DEC2BIN = function (number, places) {
  ...
  if (utils.gettype(places) === 'undefined') {
    return result;
  } else {
    // Return error if places is nonnumeric
    if (isNaN(places)) {
...
exports.IMABS = function (inumber) {
  ...
  const x = exports.IMREAL(inumber);
  const y = exports.IMAGINARY(inumber);
...
exports.IMDIV = function (inumber1, inumber2) {
  // Lookup real and imaginary coefficients using Formula.js [http://formulajs.org]
  const a = exports.IMREAL(inumber1);
  const b = exports.IMAGINARY(inumber1);
  const c = exports.IMREAL(inumber2);
  const d = exports.IMAGINARY(inumber2);
...
exports.IMPOWER = function (inumber, number) {
  ...
  const p = Math.pow(exports.IMABS(inumber), number);

  // Calculate argument
  const t = exports.IMARGUMENT(inumber);
...
exports.IMPRODUCT = function () {
  ...
  for (let i = 1; i < arguments.length; i++) {
    ...
    const a = exports.IMREAL(result);
    const b = exports.IMAGINARY(result);
    const c = exports.IMREAL(arguments[i]);
    const d = exports.IMAGINARY(arguments[i]);
...
exports.IMSQRT = function (inumber) {
  ...
  // Calculate power of modulus
  const s = Math.sqrt(exports.IMABS(inumber));
...
exports.IMSUB = function (inumber1, inumber2) {
  // Lookup real and imaginary coefficients using Formula.js [http://formulajs.org]
  const a = this.IMREAL(inumber1);
  const b = this.IMAGINARY(inumber1);
  const c = this.IMREAL(inumber2);
  const d = this.IMAGINARY(inumber2);
...
exports.IMSUM = function () {
  ...
  for (let i = 1; i < args.length; i++) {
    // Lookup coefficients of two complex numbers
    const a = this.IMREAL(result);
    const b = this.IMAGINARY(result);
    const c = this.IMREAL(args[i]);
    const d = this.IMAGINARY(args[i]);
